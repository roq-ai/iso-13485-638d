  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience seamless document management with ISO 13485, your trusted partner for ISO Certificate Repository."
        />
      </Head>
      ...
      <Stack minH={'100vh'} direction={{ base: 'column', md: 'row' }}>
        <Flex p={8} flex={1} align={'center'} justify={'center'}>
          <Stack position="relative" spacing={6} w={'full'} maxW={'lg'}>
            ...
            <Text fontSize={{ base: 'md', lg: 'lg' }} color={'gray.500'}>
              {`Experience seamless document management with ISO 13485, your trusted partner for ISO Certificate Repository.`}
            </Text>
        ...
        <Flex position="relative" flex={1}>
          <Image
            src={
              'https://images.unsplash.com/photo-1521791055366-0d553872125f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxkb2N1bWVudCUyQ0lTTyUyMGNlcnRpZmljYXRlfGVufDB8fHx8MTY4ODM2NDg5MHww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt={'Login Image'}
            objectFit={'cover'}
          />
