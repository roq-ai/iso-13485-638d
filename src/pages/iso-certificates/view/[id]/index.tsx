...
import { getIsoCertificateById } from 'apiSdk/iso-certificates';
...
function IsoCertificateViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Iso Certificate Detail View
          </Text>
          {hasAccess('iso_certificate', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/iso-certificates/edit/${data?.id}`} passHref legacyBehavior>
              <Button
          ...
          <>
            <Stack direction="column" spacing={2} mb={4}>
              ...
              <Flex alignItems="center">
                ...
                <Text fontSize="md" as="span" ml={3}>
                  {data?.validity_date as unknown as string}
                </Text>
              </Flex>
              <Flex alignItems="center">
                <Text fontSize="lg" fontWeight="bold" as="span">
